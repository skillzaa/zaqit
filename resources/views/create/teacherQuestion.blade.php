...
@section('content')
<div class="container">
    <h2>Add a Question (Teacher / Supervisor)</h2>
<form method="POST" action="{{ URL::to('/teacher') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
<div class="form-group row">
<label for="titleid" class="col-sm-3 col-form-label">
   Subjects Authorised:</label>
   <br/>
<div class="col-sm-9">
<input type="hidden" name="subject_id" value="{{$data['subject']->id}}">
<span><b>{{$data['subject']->name}}</b></span>
</div>
</div>
